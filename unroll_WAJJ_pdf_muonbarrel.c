...
int unroll_WAJJ_pdf_muonbarrel(){
    setTDRStyle();
    ...
    TFile* fout = new TFile("WAJJ_pdf.root","RECREATE");
    ...
    TFile* f_WAJJ=TFile::Open("./th2-histo-WAJJ-pdf-muonbarrel.root");
    TH2D* th2_WAJJ[104];
    TH1D* t_WAJJ[104];
    ...
    for(Int_t i=0;i<104;i++){
        ...
        ofstream file2(Form("./scale-txt-WAJJ-pdf-muonbarrel/content-hist_no%d",i+1));
